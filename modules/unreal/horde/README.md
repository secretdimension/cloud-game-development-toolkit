...
| <a name="input_extra_global_config"></a> [extra\_global\_config](#input\_extra\_global\_config) | Extra json to include in the globals.json config file | `map(any)` | `{}` | no |
